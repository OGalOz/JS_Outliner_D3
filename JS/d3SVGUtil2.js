...
function getSVG(svg_id='graph-svg') {
        //svg_id is str
...
function addPartialcircle(d3svg, start_angle, end_angle, 
                          center_coordinates, radius, internal_color, 
                           id = null) {
    /* Args:
     *      d3svg: d3 svg object 
     *      start_angle, end_angle, radius, line_width: Num (ANGLES ARE RADIANS)
     *      center_coordinates: <Num, Num>
     *      internal_color, id: str
     *      
     *      Note, this can make semi circle if start & end are Pi away
...
function addPolygon(d3svg, path_coordinates, fill_color, id = null,
     ...
     *      coordinate: list<x (Num), y (Num)>
     * 
     * onclick_obj: 
     *      onclick_func: javascript function
     *      onclick_params: list<>
     *
     * ondrag_obj: 
